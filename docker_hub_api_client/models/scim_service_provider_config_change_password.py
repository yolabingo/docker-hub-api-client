...
T = TypeVar("T", bound="ScimServiceProviderConfigChangePassword")
...
class ScimServiceProviderConfigChangePassword:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        scim_service_provider_config_change_password = cls(
            supported=supported,
        )

        scim_service_provider_config_change_password.additional_properties = d
