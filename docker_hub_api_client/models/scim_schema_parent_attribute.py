...
from ..models.scim_schema_attribute import ScimSchemaAttribute
from ..models.scim_schema_attribute_type import ScimSchemaAttributeType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ScimSchemaParentAttribute")
...
class ScimSchemaParentAttribute:
    ...
    Attributes:
        ...
        sub_attributes (Union[Unset, List[ScimSchemaAttribute]]):
    """
    ...
    sub_attributes: Union[Unset, List[ScimSchemaAttribute]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        sub_attributes: Union[Unset, List[Dict[str, Any]]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for sub_attributes_item_data in _sub_attributes or []:
            sub_attributes_item = ScimSchemaAttribute.from_dict(sub_attributes_item_data)

            sub_attributes.append(sub_attributes_item)

        scim_schema_parent_attribute = cls(
            name=name,
            type=type,
        ...
        scim_schema_parent_attribute.additional_properties = d
        return scim_schema_parent_attribute
